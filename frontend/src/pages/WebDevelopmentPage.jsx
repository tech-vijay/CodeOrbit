...
import { Send, CheckCircle2, Loader2, AlertCircle, ArrowRight, ArrowLeft, Check, Plus, Minus, Star, CreditCard, X, Lock, ShieldCheck } from 'lucide-react';
import { api } from '@/lib/api';
import { webDevSubServices, webDevProcess, techStack, webDevPricing, webDevFAQs, webDevProjects } from '@/data/webdev';

const projectTypes = ['New Website', 'Website Redesign', 'E-Commerce Store', 'Web Application', 'Other'];
const budgets = ['Under $2,000', '$2,000 - $5,000', '$5,000 - $15,000', '$15,000+', 'Not sure yet'];
const timelines = ['ASAP', '1-2 months', '3-4 months', '5+ months', 'Flexible'];
  ...
  async function handlePayment(e) {
    ...
    try {
      ...
      const razorpay = new window.Razorpay({
        ...
        name: 'Code Orbit',
        description: `${selectedPlan.name} Plan — Web Development`,
    ...
    <div className="bg-white">
      ...
      <section className="relative overflow-hidden bg-slate-950 pt-32 pb-20">
        <div className="pointer-events-none absolute inset-0">
          <img src="https://images.pexels.com/photos/3184460/pexels-photo-3184460.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop" alt="" className="h-full w-full object-cover opacity-20" />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <div className="max-w-3xl">
            <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-cyan-400">Service — Website Development</p>
            <h1 className="text-4xl font-bold leading-[1.1] text-white sm:text-5xl lg:text-6xl">Websites that load fast, rank high, and convert visitors into customers</h1>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">We design and develop fast, secure, and scalable websites that extend efficiency at its best. From corporate sites to complex web applications, our team builds digital experiences engineered for growth.</p>
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a href="#inquiry" className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-400 to-blue-600 px-7 py-3.5 text-base font-semibold text-white shadow-xl shadow-cyan-500/30 transition-all duration-300 hover:shadow-cyan-500/50 hover:brightness-110">Start Your Project<ArrowRight className="h-5 w-5 transition-transform duration-300 group-hover:translate-x-1" /></a>
              <a href="#pricing" className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-7 py-3.5 text-base font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/40 hover:bg-white/10">View Pricing</a>
            </div>
            <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3">
              {['500+ websites delivered', 'Core Web Vitals compliant', 'SEO-ready by default', '3 months free support'].map((item) => (
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">Full-spectrum web development services</h2>
            <p className="mt-4 text-base text-slate-600">From a single landing page to a full-scale web application, we cover every aspect of modern web development.</p>
          </div>
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {webDevSubServices.map((s) => (
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-600">Our Process</p>
            <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">A proven path from idea to launch</h2>
            <p className="mt-4 text-base text-slate-600">Every project follows a structured, transparent workflow designed to deliver on time and on budget — with no surprises.</p>
          </div>
      ...
      <section className="bg-slate-950 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-400">Our Tech Stack</p>
            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl">Modern tools, built to last</h2>
            <p className="mt-4 text-base text-slate-400">We use battle-tested, industry-leading technologies that ensure your website is fast, secure, and ready to scale.</p>
          </div>
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {techStack.map((cat) => (
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-600">Recent Work</p>
            <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">Web development projects we are proud of</h2>
          </div>
      ...
      <section id="pricing" className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-600">Pricing</p>
            <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">Transparent pricing for every budget</h2>
            <p className="mt-4 text-base text-slate-600">Choose a plan that fits your needs. All plans include responsive design, SEO setup, and post-launch support.</p>
          </div>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-3xl px-5 sm:px-8">
          <div className="text-center">
            <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-600">FAQ</p>
            <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">Frequently asked questions</h2>
          </div>
      ...
      <section id="inquiry" className="bg-slate-50 py-24">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-cyan-600">Request a Quote</p>
              <h2 className="text-3xl font-bold leading-tight text-slate-900 sm:text-4xl">Let's build your website</h2>
              <p className="mt-4 text-base text-slate-600">Fill out the form with your project details and we'll send you a tailored proposal within one business day. No obligation, no pressure.</p>
              <div className="mt-8 space-y-4">
                {[{ label: 'Email', value: 'hello@digitalprisma.com' }, { label: 'Phone / WhatsApp', value: '+91 89209 28177' }, { label: 'Office', value: 'Noida, Uttar Pradesh, India' }].map((c) => (
              ...
              <div className="mt-8 flex items-center gap-3 rounded-2xl border border-cyan-200 bg-cyan-50 p-5">
                ...
                <p className="text-sm text-slate-700">Rated 5.0 by 250+ clients for web development excellence</p>
              </div>
            </div>
            <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-xl sm:p-9">
              {status === 'success' ? (
                <div className="flex h-full flex-col items-center justify-center py-16 text-center">
                  ...
                  <p className="mt-2 text-base text-slate-600">Your project inquiry has been received. Our web development team will reach out within one business day with a tailored proposal.</p>
